module "rrc-margin_sandbox_project" {
  ...
  #folder_id       = data.terraform_remote_state.bootstrap1.outputs.rtcr_sub_folders.fldr-rtrc-sandbox.name
...
module "rrc-margin_sandbox_admin_iam" {
  source           = "../modules/iam/projects-iam"
  project_id       = trimprefix(module.rrc-margin_sandbox_project.project_id, "projects/")
  admin_roles      = local.admin_roles
  admin_group_name = var.admin_group_name
}

module "rrc-margin_sandbox_developer_iam" {
  source               = "../modules/iam/projects-iam"
  project_id           = trimprefix(module.rrc-margin_sandbox_project.project_id, "projects/")
...
module "rrc-margin_sandbox_devops_iam" {
  source            = "../modules/iam/projects-iam"
  project_id        = trimprefix(module.rrc-margin_sandbox_project.project_id, "projects/")
